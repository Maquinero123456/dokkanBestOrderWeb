...
async def team(request : Request, leader : int = Form(), char2 : int = Form(), char3 : int = Form(), char4: int = Form(), char5 : int = Form(), char6 : int = Form(), friend : int = Form()):
    ...
    return templates.TemplateResponse("team.html", {"request": request, "id1": personajes[0][0], "id2": personajes[1][0], "id3": personajes[2][0], "id4": personajes[3][0], "id5": personajes[4][0], "id6": personajes[5][0], "id7": personajes[6][0],
                                                    "id8": equipo[0][0], "id9": equipo[1][0], "id10": equipo[2][0], "id11": equipo[3][0], "id12": equipo[4][0], "id13": equipo[5][0], "id14": equipo[6][0]})
